...
plotter <- function() {
  ...
  if (gender == "M") {
    age <- as.numeric(chartr(
      ",",
      ".",
      strsplit(as.character(GET$age[1]), ":")[[1]]
    ))
    gen <- as.numeric(chartr(
      ",",
      ".",
      strsplit(as.character(GET$gen[1]), ":")[[1]]
    ))
    phb <- as.numeric(chartr(
      ",",
      ".",
      strsplit(as.character(GET$phb[1]), ":")[[1]]
    ))
    tv <- as.numeric(chartr(
      ",",
      ".",
      strsplit(as.character(GET$tv[1]), ":")[[1]]
    ))
  ...
  if (gender == "F") {
    ...
    bre <- as.numeric(chartr(
      ",",
      ".",
      strsplit(as.character(GET$bre[1]), ":")[[1]]
    ))
    phg <- as.numeric(chartr(
      ",",
      ".",
      strsplit(as.character(GET$phg[1]), ":")[[1]]
    ))
    men <- as.numeric(chartr(
      ",",
      ".",
      strsplit(as.character(GET$men[1]), ":")[[1]]
    ))
